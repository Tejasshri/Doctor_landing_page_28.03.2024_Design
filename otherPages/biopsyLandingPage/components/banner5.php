...
<div class="banner">
    <form class="banner__form" method="POST" action="components/formRedirectPage.php">
        ...
        <h1 class="banner__form-heading">Book Your <span style="color:var(--brandClr); ">Liver Biopsy <br class="banner__form-heading-br-el"> Now!</span></h1>
    ...
    <div class="banner__safety-hands-section">
        <h1 class="banner__safety-hands-title">Safest Hands for <Liver>Most <br class="br-1"> Accurate Liver Biopsies <span>@Rs. 2,999/-</span></h1>
        ...
        <div class="banner__specialilty-texts">
            <p>
                ...
                US Guided Liver Biopsy&nbsp;<span>@Rs. 2,999/-</span>
            </p>
            <p>
