...
<div class="banner">
    <form class="banner__form" method="POST" action="components/formRedirectPage.php">
        ...
        <h1 class="banner__form-heading">Book Your <span style="color:var(--brandClr); ">Lung Biopsy <br class="banner__form-heading-br-el"> Now!</span></h1>
    ...
    <div class="banner__safety-hands-section">
        <h1 class="banner__safety-hands-title">Safest Hands for <Lung>Most <br class="br-1"> Accurate Lung Biopsies <span>@Rs. 9,999/-</span></h1>
        ...
        <div class="banner__specialilty-texts">
            <p>
                ...
                CT Guided Lung Biopsy&nbsp;<span>@Rs. 9,999/-</span>
            </p>
            <p>
